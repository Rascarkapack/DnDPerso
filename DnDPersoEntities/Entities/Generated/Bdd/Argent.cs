...

{
    ...
    public partial class Argent : INotifyPropertyChanged, IEntity
    {
    	...
    	public int IdPersonnage
    	{
     	...
     	private int _idtypeargent;
    	public int IdTypeArgent
    	{
    		get
    		{
    			return _idtypeargent;
    		}
    		set
    		{
    			_idtypeargent = value;
    			NotifyPropertyChange("IdTypeArgent");
    		}
    	}
