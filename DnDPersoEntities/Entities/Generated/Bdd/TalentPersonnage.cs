...

{
    ...
    public partial class TalentPersonnage : INotifyPropertyChanged, IEntity
    {
    	...
    	public int IdPersonnage
    	{
     	...
     	private Nullable<int> _idtalent;
    	public Nullable<int> IdTalent
    	{
    		get
    		{
    			return _idtalent;
